...
extern int nrn_get_mechtype();
 ...
 "setdata_hh_hippoc", _hoc_setdata,
 "evaluate_fct_hh_hippoc", _hoc_evaluate_fct,
 "states_hh_hippoc", _hoc_states,
 0, 0
};
 ...
 "gnabar_hh_hippoc", "mho/cm2",
 "gkbar_hh_hippoc", "mho/cm2",
 "vtraub_hh_hippoc", "mV",
 0,0
};
	...
	Prop *_prop;
{
 ...
 _mechtype = nrn_get_mechtype(_mechanism[1]);
  ...
  hoc_register_dparam_size(_mechtype, 6);
 	...
 	ivoc_help("help ?1 hh_hippoc /home/yann/work/elphy_code/nrn_files/x86_64/hh2.mod\n");
...
static int _ode_count(_type)int _type; { hoc_execerror("hh_hippoc", "cannot be used with CVODE");}
 ...
 v=_v;
{
 ...
 for (; t < _break; t += dt) {
 error =  states();
 if(error){fprintf(stderr,"at line 70 in file hh2.mod:\n	SOLVE states\n"); nrn_complain(_p); abort_run(error);}
